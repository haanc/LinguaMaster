...
def get_dictionary_chain_with_llm(llm: BaseChatModel) -> Runnable:
    """
    Dictionary chain with externally provided LLM.
    Use this when you have a user-configured LLM provider.
    """
    parser = PydanticOutputParser(pydantic_object=VocabularyItem)
...
def get_context_chain_with_llm(llm: BaseChatModel) -> Runnable:
    """
    Context explanation chain with externally provided LLM.
    Use this when you have a user-configured LLM provider.
    """
    parser = PydanticOutputParser(pydantic_object=ContextExplanation)
...
def get_augmented_dictionary_chain_with_llm(llm: BaseChatModel) -> Runnable:
    """
    Augmented dictionary chain with externally provided LLM.
    Use this when you have a user-configured LLM provider.
    """
    parser = PydanticOutputParser(pydantic_object=VocabularyItemAugmented)
