...
- **新增：** 可拖拽学习面板 - 学习面板可以拖拽到屏幕任意位置
- **新增：** 可拖拽和调整大小的字幕 - 支持拖拽、水平调整大小、磨砂玻璃效果
- **新增：** Toast 通知 - 用现代 Toast 通知替换原生 alert() 对话框
- **修复：** 启动画面图标加载失败
- **修复：** 全屏字幕显示 - 全屏模式下字幕正常显示
- **修复：** 响应式字幕定位 - 窗口大小变化时字幕保持相对位置
- **修复：** LLM 设置滚动条样式与深色主题统一

<details>
<summary>历史版本: v0.0.8</summary>

- **新增：** 设置页面显示应用版本号
- **修复：** 翻译解析问题 - 改进正则表达式批量翻译解析
- **修复：** Chat 端点文档 - 移除过时注释
- **优化：** 删除 61 行死代码 (audio_service.py)
- **优化：** VAD 参数调优 (400ms → 700ms) 改善转录分段
- **改进：** 短字幕片段智能合并
</details>

<details>
<summary>历史版本: v0.0.7</summary>
